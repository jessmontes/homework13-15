...
<!-- {{ ingredients }} -->
  ...
  <div class="p-10">
    ...
    <div class="grid grid-cols-4 gap-5">
        <router-link v-for="ingredient in searchIngredients" :key="ingredient.idIngredient" :to="{name: 'MealsByIngredients', params: {ingredient: ingredient.strIngredient}}" class="bg-white rounded p-3 mb-3 shadow block">
